...
//temp is an initial copy of the data so that, in the event that the api is unreachable, you can still at least navigate breeds
var temp = {
    "message": {
        "affenpinscher": [],
        "african": [],
...
class Breeds extends Component {
    ...
    render() {
        ...
        for (let i = 0; i < breedsAfterCall.length; i++) {
            ...
            //call getBreedPics and pass in to breed component
